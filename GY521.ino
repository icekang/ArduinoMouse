...
if (abs(values.GyX) < SENSITIVITY) values.GyX = 0;
if (abs(values.GyY) < SENSITIVITY) values.GyY = 0;
if (abs(values.GyZ) < SENSITIVITY) values.GyZ = 0;
...
Serial.print(" °C| AcX = "); Serial.print(xp);
Serial.print(" g| AcY = "); Serial.print(y);
Serial.print(" g| AcZ = "); Serial.print(zp);Serial.println(" g");
}
